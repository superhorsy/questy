...
// ErrSeparator is used to determine the boundaries of the errors in the hierarchy.
const ErrSeparator = " -- "
...
// Is implements https://golang.org/pkg/errors/#Is allowing an Error
...
// wrappedError is an backend error type that allows the wrapping of
